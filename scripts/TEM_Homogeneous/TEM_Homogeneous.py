# TEM_Homogeneous
# Simulate an EDS spectrum of a TEM sample with homogeneous composition.
#
# Author: Lukas Gruenewald, last updated: 07.10.24
...
nTrajShow = 200  # number of trajectories in image
...
# xtraParams.update(mc.configureContinuumImages([[0, e0]], imgSzNm*1.0e-9, imgSize))
...
sim = mc.multiFilm(
    layers=[[sample, thickness * 1e-9]],  # convert nm to m
    det=det,
    e0=e0,
    withPoisson=Poisson,
    nTraj=nTraj,
...
# Save detector properties as txt and html
